...
* Program name : JALSG-GML219_STAT_Fig6_4.4.4b.OS_byFABWHO.sas
* Author       : AKIKO SAITO
* Date created : 20260504
* Description  : FAB/WHO分類別 2年・5年OS (SAP 4.4.4b)
**********************************************************************;
...
proc printto log="&log.\JALSG-GML219_STAT_Fig6_&DATE..log" new; run;
...
ods rtf file="&output.\JALSG-GML219 Fig6_&DATE..rtf" style=listing;
ods escapechar='^';
...
/*--- FAB分類別 OS ---*/
title2 'FAB分類別 Overall Survival（2年・5年）';
title3 '解析対象集団: FAS  分類: M0/M6/M7/Unknown vs Others';

ods graphics on / width=18cm height=14cm imagename="Fig6_OS_byFAB";
...
%km_strata(_surv_fab, OS_y, fabgrp, 2);
%km_strata(_surv_fab, OS_y, fabgrp, 5);
...
/*--- WHO分類別 OS ---*/
title2 'WHO分類別 Overall Survival（2年・5年）';
title3 '解析対象集団: FAS  分類: t-MN / AML-MRC / Others';

ods graphics on / width=18cm height=14cm imagename="Fig6_OS_byWHO";
...
%km_strata(_surv_who, OS_y, whogrp, 2);
%km_strata(_surv_who, OS_y, whogrp, 5);
