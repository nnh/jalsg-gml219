...
* Program name : JALSG-GML219_STAT_Fig5_4.4.4a.OS.sas
* Author       : AKIKO SAITO
* Date created : 20260504
* Description  : Overall Survival 2年・5年 (FAS) (SAP 4.4.4a)
**********************************************************************;
...
proc printto log="&log.\JALSG-GML219_STAT_Fig5_&DATE..log" new; run;
...
ods rtf file="&output.\JALSG-GML219 Fig5_&DATE..rtf" style=listing;
ods escapechar='^';
footnote2 "^S={just=r} 出力日 &DATE";

/*--- KMカーブ ---*/
title2 'Overall Survival（2年・5年）';
title3 '解析対象集団: FAS';

ods graphics on / width=18cm height=14cm imagename="Fig5_OS_FAS";
