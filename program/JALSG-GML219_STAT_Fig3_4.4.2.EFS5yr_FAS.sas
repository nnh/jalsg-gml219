...
* Program name : JALSG-GML219_STAT_Fig3_4.4.2.EFS5yr_FAS.sas
* Author       : AKIKO SAITO
* Date created : 20260504
* Description  : 5年Event-free survival (FAS) (SAP 4.4.2)
**********************************************************************;
...
title2 'Event-free Survival（5年）';
title3 '解析対象集団: FAS';

ods graphics on / width=18cm height=14cm imagename="Fig3_EFS5yr_FAS";
proc lifetest data=FAS plots=survival(atrisk cl) notable;
  time EFS_y*efs_c(0);
run;
ods graphics off;

title2 'EFS 時点別推定値（1・2・3・5年）';
title3 ' ';
